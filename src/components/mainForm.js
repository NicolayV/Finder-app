...
import { LoginForm } from './forms/login/LogForm';
import { RegistrationForm } from './forms/registration/RegForm';
	...
	return (
		...
		>
			<Paper elevation={20} style={{ width: 320 }}>
				...
				{(selectedTab === 0 && <LoginForm />) || (selectedTab === 1 && <RegistrationForm />)}
			</Paper>
		</Grid>
	);
}
