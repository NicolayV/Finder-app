...
import { appDBs } from "../../../store/actions/allAppDB";

import { getUsers } from "../../../apiMovies";

export const RegistrationForm = () => {
  const dispatch = useDispatch();
  const { authLogOut, authSucces, setUserLogIn, setUserLogOut } =
    bindActionCreators(actionCreators, appDBs, dispatch);
